...
/**
 * @title InterestRateStrategy contract
...
//   ILendingPoolAddressesProvider public immutable addressesProvider;
  ...
  /**
   * @dev Calculates the interest rates depending on the asset reserve's state and configurations
   * @param asset The address of the asset
   * @param fToken The address of the fToken
  ...
  {
    uint256 availableLiquidity = IERC20(asset).balanceOf(fToken);
  ...
  /**
   * @dev Calculates the overall borrow rate
   * @param totalVariableDebt The total borrowed from the reserve at a variable rate
