...
library Errors {
  ...
  //lend pool errors
  string public constant LP_CALLER_NOT_CONFIGURATOR = "400"; // 'The caller of the function is not the lending pool configurator'
  ...
  string public constant LP_CALLER_MUST_BE_AN_FTOKEN = "410";
  ...
  //common token errors
  string public constant CT_CALLER_MUST_BE_LENDING_POOL = "500"; // 'The caller of this function must be a lending pool'
