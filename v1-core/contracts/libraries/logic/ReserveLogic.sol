...
library ReserveLogic {
    ...
    **/
    function getNormalizedIncome(DataTypes.Reserve storage reserve) internal view returns (uint256) {
    ...
    **/
    function getNormalizedDebt(DataTypes.Reserve storage reserve) internal view returns (uint256) {
        uint40 timestamp = reserve.lastUpdateTimestamp;
    ...
    **/
    function updateState(DataTypes.Reserve storage reserve) internal {
        ...
        uint256 scaledVariableDebt = 10; // TODO: update DebtToken
    ...
    * @param reserve The reserve object
    * @param fTokenAddress The address of the overlying fToken contract
    ...
    **/
    function init(
        ...
        require(reserve.fTokenAddress == address(0), Errors.RL_RESERVE_ALREADY_INITIALIZED);
        ...
        // reserve.configuration.asset = asset;
        // reserve.configuration.collateral = collateral;
        reserve.configuration.reserveFactor = reserveFactor;
    }
    ...
    **/
    function updateInterestRates(
        ...
        (vars.newLiquidityRate, vars.newVariableRate) = IInterestRateStrategy(reserve.interestRateStrategyAddress).calculateInterestRates(
            reserveAddress,
            fTokenAddress,
            liquidityAdded,
            liquidityTaken,
            ...
            5 // TODO: link-up reserve factor of 5%
        );
    ...
    **/
    function _mintToTreasury(
        ...
        if (vars.amountToMint != 0) {
            IFToken(reserve.fTokenAddress).mintToTreasury(vars.amountToMint, newLiquidityIndex);
        }
    }
