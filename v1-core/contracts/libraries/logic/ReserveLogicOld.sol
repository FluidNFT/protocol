...
//     //     returns (uint256)
//     // {
//     //     (reserve.lastUpdateTimestamp, reserve.liquidityIndex) = getNormalizedIncome(reserve);
...
//     //         vars.timeDelta = 0;
//     //     } else {
//     //         vars.timeDelta = timestamp.sub(reserve.lastUpdateTimestamp);
//     //     }
